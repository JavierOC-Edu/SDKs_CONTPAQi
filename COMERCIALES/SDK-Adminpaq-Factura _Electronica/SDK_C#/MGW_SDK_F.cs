...
namespace SDKFacturaElectronica
{
    class MGW_SDK_F
    {
        ...
        [DllImport("MGW_SDK.dll", EntryPoint = "fAbreEmpresa")]
            ...
            [DllImport("MGW_SDK.dll", EntryPoint = "fCancelaUUID33")]
            public static extern int fCancelaUUID33(string aUUID, string RFCReceptor , double aTotal , string aIdDConcepto, string aPass, ref int aEstatusCancelacion);

            [DllImport("MGW_SDK.dll", EntryPoint = "fCancelaUUID40")]
            public static extern int fCancelaUUID40(string aUUID, string aMotivoCancelacion, string aUUIDReemplaza,  string RFCReceptor, double aTotal, string aIdDConcepto, string aPass, ref int aEstatusCancelacion);
        ...
        [DllImport("MGW_SDK.dll", EntryPoint = "fCierraEmpresa")]
            ...
            public static extern int fTimbraXML(string aRutaXML, string aCodCOncepto,  ref string  aUUID, string aRutaDDA, string aRutaResultado, string aPass, string aRutaFormato);
            ...
            public static string fErrorDescripcion( int cError)
            {
                StringBuilder descripcion = new StringBuilder(512);
